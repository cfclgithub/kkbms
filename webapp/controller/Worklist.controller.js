sap.ui.define([
	...
	return BaseController.extend("com.cfcl.kkbms.controller.Worklist", {
		...
		onValueHelpRequestedEvent: function (oEvent) {
			...
			if (!this._eventDialog) {
				this._eventDialog = Fragment.load({
					id: oView.getId(),
					name: "com.cfcl.kkbms.view.fragments.multiSelectEvents",
					controller: this
		...
		_handlePresstemplate: function () {
			...
			if (!this.templateFragment) {
				this.templateFragment = this._createFragment(fragId, "com.cfcl.kkbms.view.fragments.template");
		...
		onValueHelpRequestedRfq: function (oEvent) {
			if (!this._pDialog) {
				this._pDialog = sap.ui.xmlfragment("com.cfcl.kkbms.view.fragments.tableSelectRfq", this);
